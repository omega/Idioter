...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{IDIOTER_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{IDIOTER_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
idioter_server.pl - Catalyst Testserver

=head1 SYNOPSIS

idioter_server.pl [options]
